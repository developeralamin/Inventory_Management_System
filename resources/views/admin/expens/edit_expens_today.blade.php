...
<div class="content">
 ...
 <div class="row">
  ...
  <div class="col-sm-12">
   <div class="panel panel-info">
    <div class="panel-heading">
      <h3 class="panel-title text-white"> Update Expense</h3>
      
    </div>
      <div class="panel-body">
        <a href="" class="btn  btn-info pull-right">This Month</a>
  ...
  <form class="cmxform form-horizontal tasi-form" method="post" 
    action="{{ url('/update_today_expense/'.$expense->id) }} " enctype="multipart/form-data">
    @csrf
       ...
       <div class="form-group ">
         ...
         <div class="col-lg-10">
          <textarea class="form-control" rows="10" cols="10" id="details" name="details"  type="text">{{ $expense->details }}</textarea>
        ...
        <div class="form-group ">
         ...
         <div class="col-lg-10">
          <input class="form-control" value="{{ $expense->amount }}" id="amount" name="amount" placeholder="Amount" type="text">
   ...
   <a class="btn btn-default waves-effect" href="{{  route('today.expense') }}">Cancel</a>
 </div>
</div>
